...
Please refer to the "CASA Lib for AS3 documentation":http://as3.casalib.org/docs/ . Info specific to this haXe port is expained below.

h1. Note

For targets other than Flash, casahx needs nme, neash and canvas-nme. 

To compile test.hxml, remember to modify the path to canvas-nme and the path to your local test server first.
...
Seems that it is a bug of canvas-nme, it cannot detect the mouse move event in JS target.
